    ...
    <section className="relative pt-24 pb-16 bg-gradient-to-br from-primary/10 to-accent/10">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-primary mb-6 font-[family-name:var(--font-heading)]">
          About Steve's Auto Interior
        </h1>
        <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
          Over 20 years of dedicated service to the Beverly and Edgewater Park communities, specializing in auto
          interior restoration, sunroof repair, and convertible top services
        </p>
